...
for (var i in FAMILY_NAME_1)
	exports.FAMILY_NAME_1[FAMILY_NAME_1[i]] = 1;
	
exports.FAMILY_NAME_2 = {};
for (var i in FAMILY_NAME_2)
	exports.FAMILY_NAME_2[FAMILY_NAME_2[i]] = 2;
	
exports.DOUBLE_NAME_1 = {};
for (var i in DOUBLE_NAME_1)
	exports.DOUBLE_NAME_1[DOUBLE_NAME_1[i]] = 1;
	
exports.DOUBLE_NAME_2 = {};
for (var i in DOUBLE_NAME_2)
	exports.DOUBLE_NAME_2[DOUBLE_NAME_2[i]] = 2;
	
exports.SINGLE_NAME = {};
for (var i in SINGLE_NAME)
	exports.SINGLE_NAME[SINGLE_NAME[i]] = 1;
